            ...
            <div className='h-full flex items-center'>
                <div>
                    ...
                    <div className='relative '>
                        ...
                        <p className='text-2xl mb-6 italic indent-8'>&ldquo;Durante mis 2 años de experiencia en la empresa, participé en proyectos innovadores que me permitieron crecer profesionalmente y colaborar con equipos excepcionales.&rdquo;</p>
                    </div>
